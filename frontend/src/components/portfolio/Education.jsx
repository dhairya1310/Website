      ...
      <div className="grid md:grid-cols-2 gap-6">
        {EDUCATION.map((e, i) => (
          <Reveal key={e.degree} delay={i * 0.08}>
            <div className="h-full rounded-2xl border border-[var(--line)] bg-[var(--surface)] p-8 hover:border-[var(--teal)]/40 transition-colors duration-300" data-testid="education-card">
              <GraduationCap size={24} className="text-[var(--teal)] mb-6" />
              <h3 className="font-display text-2xl text-[var(--text)] font-medium leading-snug">{e.degree}</h3>
